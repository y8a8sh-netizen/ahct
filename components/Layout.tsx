...
import { Menu, BookOpen, Users, LayoutDashboard, LogOut, UserCheck, Shield, CalendarDays, Sparkles, X, Printer, UserPlus, KeyRound, ScrollText } from 'lucide-react';
          ...
          {canSeeManager && (
            <>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-sm md:text-base ${activeTab === 'instructions' ? 'bg-white/20 font-bold' : 'hover:bg-white/10'}`}
              >
                <ScrollText size={20} className="text-tvtc-gold" />
                <span>التعليمات</span>
              </button>
            </>
          )}
